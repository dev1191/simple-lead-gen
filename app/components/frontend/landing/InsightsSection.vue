      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <CardContent class="p-0">
            <!-- Image Container -->
            <div
              class="relative bg-gradient-to-br from-purple-100 to-blue-100 h-48 flex items-center justify-center"
            >
              <div
                class="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300"
              >
...
import { Building2, Cpu, Banknote, ChevronRight } from "lucide-vue-next";
